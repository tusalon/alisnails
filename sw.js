...
const CACHE_NAME = 'alisnails-v49';
const urlsToCache = [
  '/alisnails/',
  '/alisnails/index.html',
  '/alisnails/admin.html',
  '/alisnails/admin-login.html',
  '/alisnails/calendar.html',
  '/alisnails/setup-wizard.html',
  '/alisnails/editar-negocio.html',
  '/alisnails/manifest.json',
  '/alisnails/icons/icon-72x72.png',
  '/alisnails/icons/icon-96x96.png',
  '/alisnails/icons/icon-128x128.png',
  '/alisnails/icons/icon-144x144.png',
  ...
  '/alisnails/utils/push-config.js',
  '/alisnails/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/alisnails/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/alisnails/icons/icon-192x192.png',
    badge: '/alisnails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/alisnails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/alisnails/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Alis Nails');
